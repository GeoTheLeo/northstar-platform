...
st.set_page_config(
    page_title="NorthStar BI Decision Command Center",
    layout="wide",
)
...
st.title(
    "NorthStar BI Decision Command Center"
)

st.markdown(
    """
    Executive analytics and decision-support dashboard
    integrating predictive analytics, learner segmentation,
...
st.caption(
    "NorthStar AI Learning Intelligence Platform • BI Decision Command Center"
)